                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('transaksi_penjualan_ugd')" style="cursor: pointer;">Service UGD</h4>
                            ...
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('transaksi_penjualan_pasen')" style="cursor: pointer;">Service PASEN</h4>
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td>No Invoice</td>
                                            <td>Tgl Transaksi</td>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('transaksi_penjualan_pasen')" style="cursor: pointer;">Service URC</h4>
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td>No Invoice</td>
                                            <td>Tgl Transaksi</td>
                            ...
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('transaksi_penjualan_posyandu')" style="cursor: pointer;">Service POSYANDU</h4>
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td>No Invoice</td>
                                            <td>Tgl Transaksi</td>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('transaksi_penjualan_visit')" style="cursor: pointer;">Service VAKSIN</h4>
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td>No Invoice</td>
                                            <td>Tgl Transaksi</td>
                            ...
                            <div class="col-xs-12 col-lg-6">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-20" onclick="window.location.assign('list_artikel')" style="cursor: pointer;">Service ARTIKEL</h4>
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            <td>Id Artikel</td>
