                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">List Desain (UGD)</h4>
                                ...
                                <div class="card-box card-scroll-2 scroll-xy">
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no=1;
                                                $dataDesain=mysql_query("SELECT * FROM tb_desain JOIN tb_kategori ON tb_desain.id_kategori=tb_kategori.id_kategori WHERE SUBSTR(pemilik,1,2)='AD'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit_desain?id=<?=$dataTables['id_desain'];?>" class="txt-edit">Edit</a>&nbsp;<a href="javascript:hapusDesain('<?=$dataTables['id_desain'];?>')" class="txt-hapus">Hapus</a></td>
                                                </tr>
                                                <?php
                                                $no++;
                                                }
