            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah Apotik</h4>
                        ...
                        <form method="POST" action="php/proses_artikel.php" enctype="multipart/form-data">                            
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <h4 class="header-title m-t-0">Foto Apotik</h4>
                                                <p class="text-muted font-13 m-b-30">
                                                    Masukan desain anda, dengan format png, jpg, jpeg atau bmp. Ukuran maksimal gambar adalah 1MB dan jumlah Gambar yang akan masuk hanya 5 gambar
                                                </p>
                                                <div class="card">
                                                    <div class="p-20">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="card" style="padding: 10px;">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-lg-6">
                                                            <div class="form-group">
                                                                <label>Judul Artikel</label><small id="ketNama"></small>
                                                                <input type="text" name="judul" class="form-control" onkeyup="cekNama(this.value)">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 col-lg-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="isi" id="dekripsi" class="form-control" rows="5" style="resize: none; display: none;"></textarea>
                                                    </div>                                                  
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <br>
                                        <center>
                                            <button type="submit" name="tambahApotek" class="btn btn-md btn-primary-outline waves-effect waves-light w-md">Simpan</button>
