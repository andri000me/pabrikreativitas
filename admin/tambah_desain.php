                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah Desain</h4>
                                    ...
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <h4 class="header-title m-t-0">Foto Desain</h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="namaDesain" class="form-control" onkeyup="cekNama(this.value)">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Harga Desain (Rp)</label><small> Keuntungan <?=$persen;?>% Dari Harga Desain</small>
                                                                <input type="text" name="hargaDesain" class="form-control autonumber" data-a-sep="." data-a-dec=",">
                                                            </div>
