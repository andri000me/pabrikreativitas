...
<html>
    <head>
        ...
        <!-- App title -->
        <title>List Proses Cetak (URC)</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">List Proses Cetak (URC)</h4>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="proses_cetak?id=<?=$dataTables['no_invoice'];?>" class="txt-look">Lihat</a></td>
                                                </tr>
                                                <?php
                                                $no++;
                                                }
