    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">List Negara</h4>
                                ...
                                <div class="card-box card-scroll-2 scroll-xy">                              
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no=1;
                                                $dataAdmin=mysql_query("SELECT * FROM tb_negara");
                                                while ($dataTables=mysql_fetch_array($dataAdmin)) {
                                                ?>
                                                <tr>
                                                    <td><?=$no;?></td>
                                                    <td><?=$dataTables['kode_negara'];?></td>
                                                    <td><?=$dataTables['nama_negara'];?></td>
                                                    <td><a href="edit_negara?id=<?=$dataTables['kode_negara'];?>" class="txt-edit">Edit</a>&nbsp;<a href="javascript:hapusAdmin('<?=$dataTables['kode_negara'];?>')" class="txt-hapus">Hapus</a></td>
                                                </tr>
                                                <?php
                                                $no++;
                                                }
        ...
        <script type="text/javascript">
            function hapusAdmin(id){
                alertify.confirm('Perhatian', 'Anda Yakin Akan Menghapus '+id, function(){ window.location.assign('php/proses_negara?hps='+id) }
