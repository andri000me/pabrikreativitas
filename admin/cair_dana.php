...
<html>
    ...
    <body class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Cair Dana</h4>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="card-scroll-1 scroll-xy">
                                        ...
                                        <tbody>                                            
                                            <?php 
                                                $data=mysql_query("SELECT * FROM tb_buku_besar WHERE status='0'");
                                                $total=0;
                                                $no=1;
                                                while ($rincian=mysql_fetch_array($data)) {
                                                    $total=$total-$rincian['nominal'];
                                                    $Kredit=rupiah($rincian['nominal']);
                                                    $user=explode(' ',$rincian['transaksi']);
                                                    $abc=$user[2].$Kredit.$total;
                                                    $md=md5($abc);
                                                    $norek=mysql_fetch_array(mysql_query("SELECT akun_bank FROM tb_user WHERE id_user='$user[2]'"));
                                                ?>
                                                    <tr>
                                                        <td><?=$no++;?></td>
                                                        ...
                                                        <td><?=$norek['akun_bank'];?></td>
                                                        <td>
                                                            <select name="konfirmasi" onchange="konfirmasi(this.value,'<?=$user[2];?>','<?=$md;?>')">
                                                                <option selected hidden>Konfirmasi</option>
        ...
        <script type="text/javascript">
            function konfirmasi(status,wallet,md){
                window.location.assign('php/proses_dana?kd='+md+'&st='+status+'&wl='+wallet);
            }
