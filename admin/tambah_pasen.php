            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah PASEN</h4>
                        ...
                        <form method="POST" action="php/proses_pasen.php" enctype="multipart/form-data">                            
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <h4 class="header-title m-t-0">Gambar PASEN</h4>
                                        ...
                                        <br>
                                        <center>
                                            <button type="submit" name="tambahPasen" class="btn btn-md btn-primary-outline waves-effect waves-light w-md">Simpan</button>
