...
<html>
    <head>
        ...
        <!-- App title -->
        <title>List Transaksi Vaksin</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">List Transaksi Vaksin</h4>
                                ...
                                <div class="card-box card-scroll-2 scroll-xy">                              
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no=1;
                                                $dataTransaksi=mysql_query("SELECT * FROM tb_transaksi_visit JOIN tb_visit ON tb_transaksi_visit.id_visit=tb_visit.id_visit JOIN tb_user ON tb_transaksi_visit.id_user=tb_user.id_user") or die(mysql_error());
                                                while ($dataTables=mysql_fetch_array($dataTransaksi)) {
                                                    if (strlen($dataTables['nama_visit'])>12) {
                                                        $namaDesain=str_pad(substr($dataTables['nama_visit'],0,12),15,".");
                                                    }else{
                                                        $namaDesain=$dataTables['nama_visit'];
                                                    }
