...
<html>
    <head>
        ...
        <!-- App title -->
        <title>List Transaksi Posyandu</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">List Transaksi Posyandu</h4>
                                ...
                                <div class="card-box card-scroll-2 scroll-xy">                              
                                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no=1;
                                                $dataTransaksi=mysql_query("SELECT tb_transaksi.no_invoice, tb_transaksi.status, judul_jobs, tgl_transaksi, sub_total FROM tb_transaksi JOIN tb_detail_transaksi ON tb_transaksi.no_invoice=tb_detail_transaksi.no_invoice JOIN tb_jobs ON tb_detail_transaksi.id_item=tb_jobs.id_jobs JOIN tb_user ON tb_transaksi.id_user=tb_user.id_user") or die(mysql_error());
                                                while ($dataTables=mysql_fetch_array($dataTransaksi)) {
                                                    if (strlen($dataTables['judul_jobs'])>12) {
                                                        $namaDesain=str_pad(substr($dataTables['judul_jobs'],0,12),15,".");
                                                    }else{
                                                        $namaDesain=$dataTables['judul_jobs'];
                                                    }
