...
?>
<!-- Navbar -->
        <div class="navbarr navbar-custom navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="ugd?page=1&k=all" class="nav-link">UGD</a>
                        </li>
                        <li>
                            <a href="urc?page=1&k=all" class="nav-link">URC</a>
                        </li>
                        <li>
                            <a href="pasen?page=1&k=all" class="nav-link">PASEN</a>
                        </li>
                        <li>
                            <a href="posyandu?page=1&k=all" class="nav-link">POSYANDU</a>
                        </li>
                        <li>
                            <a href="apotik?page=1&k=all" class="nav-link">APOTIK</a>
                        </li>
                        <li>
                            <a href="vaksin?page=1&k=all" class="nav-link">VAKSIN</a>
                        </li>
                        <li class="nav-item dropdown notification-list" <?=$btnProfil;?>>
                            <a class="nav-link dropdown-toggle arrow-none btn btn-login-bordered navbar-btn" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">Profil
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg" aria-labelledby="Preview">
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('user/profil')">
                                        <small><a class="pull-xs-right">Profil</a></small>
                                    </div>
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('user/list_artikel')">
                                        <small><a class="pull-xs-right">Artikel</a></small>
                                    </div>
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('user/list_pasen')">
                                        <small><a class="pull-xs-right">Pasen</a></small>
                                    </div>
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('user/list_jobs')">
                                        <small><a class="pull-xs-right">Posyandu</a></small>
                                    </div>
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('user/list_transaksi')">
        ...
        <div class="button-float">
            <ul>
                <li><button class="btn btn-sm btn-floating badge bg-btn-love" data-badge="&#10003;" onclick="window.location.assign('user/my_wallet')" style="border: none; <?=$btn2;?>"><i class="fa fa-money"></i></button></li>
                <li><button class="btn btn-sm btn-floating badge bg-btn-success" data-badge="<?=$keranjang;?>" onclick="window.location.assign('user/my_transaksi')" style="border: none; margin-top:10px; <?=$btn;?>"><i class="fa fa-shopping-basket"></i></button></li>
                <li><button class="btn btn-sm btn-floating badge bg-btn-love" data-badge="<?=$jobs;?>" onclick="window.location.assign('user/my_jobs')" style="border: none; margin-top:10px; <?=$btn1;?>"><i class="fa fa-calendar-plus-o"></i></button></li>
            </ul>            
        </div>