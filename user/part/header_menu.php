                        ...
                        <li class="nav-item dropdown notification-list" <?=$btnProfil;?>>
                            <a class="nav-link dropdown-toggle arrow-none btn btn-login-bordered navbar-btn" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">Profil
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg" aria-labelledby="Preview">
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('profil')">
                                    ...
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('list_jobs')">
                                    ...
                                    <div class="dropdown-item noti-title cursor" onclick="window.location.assign('list_event')">
                                        <small><a class="pull-xs-right">Event</a></small>
                                    </div>
                                </div>
                        </li>
                        <li <?=$btnLogin;?>>
