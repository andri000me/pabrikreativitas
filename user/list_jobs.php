    ...
    ?>
        <div class="box">
            <section id="profil" class="home-margin m-t-20">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h4 class="header-title">List Protofolio Anda</h4>
                    </div>
                    <div class="col-lg-2">
                        <center> 
                            <button class="btn btn-sm bg-btn-dark" onclick="window.location.assign('tambah_jobs')"><span class="ion-plus-round"></span> Tambah Protofolio</button>
                        </center>
                    </div>
                </div>                 
                        ...
                        <?php 
                                                ...
                                                <div class="row clearfix"> 
                                                    <div class="col-sm-12 col-lg-12">
                                                        <div class="text-center">         
                                                            <h4>Oops..</h4>
                                                            <h5>Ayo ikutan cari duit</h5>
                                                            <br>
                                                            <div class="mini-menu">
                                                                <a href="tambah_jobs">Ikut Posyandu</a>
                                                            </div>
                                                        </div>
                                                    </div>                                             
                                                </div>
                            ...
                            <?php  
                                ...
                                while ($jobs=mysql_fetch_array($qJobs)) {                                    
                                    $idJobs=$jobs['id_jobs'];
                                    $qGambar=mysql_fetch_array(mysql_query("SELECT * FROM tb_gambar_jobs WHERE id_jobs='$idJobs' LIMIT 1"));
                                    $gambar='../admin/assets/images/portofolio/'.$qGambar['gambar_jobs'];
                                    switch ($jobs['status']) {
                                        case '1':
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-sm-12 col-lg-8">
                                                        <div>         
                                                            ...
                                                            <h4><?=rupiah($jobs['harga']);?></h4>
                                                            <h5 class="text-muted"><i class="fa fa-at"></i> <?=$jobs['ket_harga'];?></h5>
