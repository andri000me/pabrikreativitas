...
<html lang="en">
    ...
    ?>
        <div class="box">
            <!-- HOME -->
            <form method="POST" name="pasen" action="php/proses_jobs" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-container">
                                        <div class="card-border">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">  
                                                        ...
                                                        <input type="text" name="namaUser" class="form-control" value="<?=$profil['nama_user'];?>" readonly>   
                                                    </div>
                                                    <div class="form-group">  
                                                ...
                                                <div class="col-lg-6">   
                                                    ...
                                                    <div class="form-group">
                                                        <label>Berat Produk (dalam gram)</label>
                                            ...
                                            <div id="button">
                                                <center>  
                                                    <button type="submit" name="tambahJobs" class="btn btn-success btn-sm" id="simpan">Simpan</button>
                                                    <button type="button" onclick="window.location.assign('tambah_jobs')" class="btn btn-danger btn-sm" id="batal">Batal</button>
                                                </center>
                                            </div>
                                        </div>
                                    </div>            
        ...
        <script type="text/javascript">
            ...
            function cekNama(name){
                ...
                if (l>=30&&l<=35) {
                    ...
                    var ket='Judul Portofolio minimal 20 karakter';
                }else if(l>35){
                    var ket='Judul Portofolio maksimal 35 karakter';
                }else{
                    var ket='Judul Portofolio sesuai';
                }
