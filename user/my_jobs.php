                        ...
                        <?php                                               
                            ...
                            <?php  
                                ...
                                while ($dataTransaksi=mysql_fetch_array($qTransaksi)) {
                                    ...
                                    $qGambar=mysql_query("SELECT gambar_jobs FROM tb_detail_transaksi JOIN tb_jobs ON tb_detail_transaksi.id_item=tb_jobs.id_jobs JOIN tb_gambar_jobs ON tb_jobs.id_jobs=tb_gambar_jobs.id_jobs WHERE no_invoice='$noInvoice'");
                                    $dGambar=mysql_fetch_array($qGambar);
                                    $tglTransaksi=$dataTransaksi['tgl_transaksi'];
                                    $mdInv=md5($noInvoice);                                    
                                    $namaItem=$dataTransaksi['judul_jobs'];
                                    $hargaItem=$dataTransaksi['harga']*$dataTransaksi['qty'];;
                                    $gambar='../admin/assets/images/portofolio/'.$dGambar['gambar_jobs'];
