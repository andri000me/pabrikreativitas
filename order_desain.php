            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-sm-12 col-md-5">
                        ...
                        <br>
                        <center>
                            <input type="hidden" id="kd" value="<?=md5($idUser),md5($idDesain);?>">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            ...
                                            <?php 
                                                  ...
                                                  $cekColor=$bgColor[0];
                                                  if($cekColor=='1') {
                                                      $tampilColor="style='display:block;'";
                                                  }else{
                                                      $tampilColor="style='display:none;'";
                                                  }
                                              ?>
                                            <div class="form-group" <?=$tampilColor;?>>
                                                <label>Warna Background</label>
                                                <br>
                                                <?php 
                                                    $warna=explode('.', $desain['color_background']);
                                                    $listWarna=explode(',', $warna[1]);
                                                    $banyakWarna=count($listWarna);
                                                    for ($i=0; $i<$banyakWarna ; $i++) { ?>  
                                                    <div class="radio-inline">
                                                      <input type="radio" name="slColor" onclick="color(this.value);" value="<?=$listWarna[$i];?>"><?=$listWarna[$i];?>
                                                    </div>   
                                                    <?php
                                                    }
                                                ?>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>Total</label>
                                                <input type="text" name="total1" id="total" class="form-control" style="margin-bottom: 5px;" readonly>
        ...
        <script type="text/javascript">
            ...
            function keranjang(idDesain, user){
                ...
                if (qty!='') {
                    ...
                    var total=t.replace('.','');
                    window.location.assign('user/php/proses_desain?kd='+kd+'&id='+idUser+'&q='+qty+'&i='+item+'&t='+total+'&cg='+bg+'&cat='+csTxt);
                }else{
