...
<html lang="en">
    ...
    if (isset($_GET['id'])) {
    	$idJobs=$_GET['id'];
 		$qJobs=mysql_query("SELECT * FROM tb_jobs JOIN tb_user ON tb_jobs.id_user=tb_user.id_user WHERE id_jobs='$idJobs'");
    ...
    <form method="POST" action="assets/php/proses_desain.php">        
                        ...
                        <div class="col-sm-12 col-md-5">
                            ...
                            <center>
                                <div class="form-inline">
                                    ...
                                    <select class="form-control" onchange="ubahStatus(this.value,'<?=$_GET['id'];?>')">
        ...
        <script type="text/javascript">
            function ubahStatus(status,idArtikel){
                window.location.assign('admin/php/proses_posyandu.php?st='+status+'&id='+idArtikel);
            }
