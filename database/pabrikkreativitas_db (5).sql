...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Jan 2019 pada 02.58
...
INSERT INTO `tb_admin` (`id_admin`, `nama_admin`, `tgl_lahir`, `jenis_kelamin`, `no_hp`, `email`, `username`, `alamat`, `password`, `pertanyaan`, `posisi`, `foto_profil`, `foto_sampul`) VALUES
('ADM221120181413', 'Rafi', '1996-10-14', 1, '085795851996', 'admin@pabrikkreativitas.com', 'Rafisf', 'alamat di bandung', 'Rfauzi14', 'p3-uus', 1, 'img_man.png', 'img_sampul.png'),
('ADM271120181210', 'Yuni', '1997-01-12', 0, '085795851997', 'y.widya12@gmail.com', 'yuni12', 'Lembang', 'yuni1122', 'p3-rafi', 0, 'img_woman.png', 'img_sampul.png');
...
INSERT INTO `tb_cetak` (`id_cetak`, `jenis_cetak`, `format`, `min_pesan`, `max_pesan`, `harga`, `ket_harga`, `deskripsi`, `icon`) VALUES
('CT11122018313', 'Id Card', '9x5,5x9', 100, 500, 5750, 'per pcs', 'Cetak ID Card adalah proses mencetak kartu pada material kertas pvc dengan mesin cetak offset, <br>sablon atau digital print sehingga menjadi sebuah Kartu ID Card dengan ukuran dan ketebalan yang sama seperti Kartu ATM.<br>Pencetakan id card bisa dilengkapi dengan data personalisasi seperti photo, barcode, nomer karyawan dan lain-lain.<br>Maka dari itulah Kami menerima jasa cetak beberapa kartu yaitu Kartu Member, Kartu Pasien, Kartu Mahasiswa, Kartu Pelajar,<br>Kartu Asuransi, Kartu Garansi, Kartu Anggota,', 'CT11122018313-1.png');
...
INSERT INTO `tb_desain` (`id_desain`, `nama_desain`, `tgl_upload`, `harga`, `color_background`, `favorit`, `deskripsi`, `id_kategori`, `pemilik`, `status`) VALUES
('D0301201913023', 'Gambar PASEN Gambar PASEN', '2019-01-03', 57500, '', 0, 'Gambar PASENGambar PASENGambar PASENGambar PASEN<br>Gambar PASENGambar PASEN<br>Gambar PASEN<br>Gambar PASENGambar PASENGambar PASEN', 'KB2', 'ADM221120181413', '1'),
('D27122018382', 'Gaya Minimalist Desain', '2018-12-27', 80500, '1.Monokrom,Fullcolor', 0, 'Desain minimalis adalah salah satu gaya desain yang paling signifikan abad ini. <br>Desain minimalis mungkin bukanlah yang paling populer, tetapi memiliki pengaruh ke hampir segala bidang. <br>Pengaruh desain minimalis bisa dibilang menembus lebih banyak bidang daripada hampir semua tren seni atau gaya desain lainnya.', 'KB4', 'ADM221120181413', '1'),
('D2712201857021', 'Front-end development', '2018-12-27', 690000, 'minimalis colorfull,minimalis monocrom', 1, 'Front-end web development is the practice of converting data to graphical interface for user <br>to view and interact with data through digital interaction using HTML, CSS and JavaScript.', 'KB1', 'US221220181220', '1');
...
INSERT INTO `tb_jobs` (`id_jobs`, `judul_jobs`, `harga`, `ket_harga`, `deskripsi`, `status`, `id_user`) VALUES
('J03012019084', 'coba input posyandu aja', 9600000, 'per data', 'coba input posyandu ajacoba input posyandu aja<br>coba input posyandu ajacoba input posyandu ajacoba input posyandu aja', 1, 'ADM221120181413'),
('J03012019544', 'coba input posyandu', 9600000, 'per data', 'coba input posyandu ajacoba input posyandu aja<br>coba input posyandu ajacoba input posyandu ajacoba input posyandu aja', 1, 'ADM221120181413'),
('J28122018293', 'Data Analysis Marketing', 5000000, 'per bulan', 'Analisis data adalah proses pemeriksaan, pembersihan, transformasi, dan pemodelan data<br>dengan tujuan menemukan informasi yang berguna, memberi tahu kesimpulan, dan mendukung pengambilan keputusan.', 1, 'US191120181418');
...
INSERT INTO `tb_user` (`id_user`, `nama_user`, `tgl_lahir`, `jenis_kelamin`, `no_hp`, `email`, `username`, `alamat`, `password`, `pertanyaan`, `foto_profil`, `foto_sampul`, `akun_bank`) VALUES
('US191120181418', 'Rafi Fauzi', '1996-10-14', 1, '085795851996', 'mrafi.sfauzi@gmail.com', 'Rafisf', 'Jl sadang subur 2 no.6/16 Rt.03 Rw.14', 'Rfauzi14', 'p4-nasi goreng', 'US191120181418-fp.jpg', 'US191120181418-sp.jpg', 'BNI-0769731979-Rafi'),
('US221220181220', 'Toped Bula', '1997-01-12', 0, '085795851997', 'Toped@gmail.com', 'Toped', 'Lembang', 'Toped123', 'p3-rafi', 'img_woman.png', 'img_sampul.png', 'BRI-037701000435301-Toped');
